...
#define PAN_TILT_ZOOM_FOCUS     128
#define DOLLY_LIFT              129
#define PAN_TILT_SET_ABSOLUTE   130
#define ZOOM_FOCUS_SET_ABSOLUTE 131
#define DOLLY_LIFT_SET_ABSOLUTE 132
#define RESERVED_SET_ABSOLUTE   133
